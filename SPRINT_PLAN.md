...
**2026-07-11 — S0 offline train-mean calibration.** Using only the frozen v3 train/dev artifacts (1,000/200 examples; layer 13; extraction `1b80f78fefda0714563dfc646ceb5d69e1758967b48f7ba66431e357d63e6767`), candidate-wise means were estimated on train and subtracted from dev logits. J-lens raw→centered dev metrics were top-1 0.060→0.075, MRR 0.2124→0.2113, and log loss 3.7019→2.7764; its maximum argmax-label share fell 1.000→0.335 and empirical argmax entropy rose 0.000→2.4498 bits, so G-CONST passed. Logit lens raw→centered was top-1 0.060→0.070, MRR 0.2081→0.2145, and log loss 4.1652→2.7887. Next-token raw→centered was top-1 0.105→0.125, MRR 0.2687→0.3035, and log loss 4.3823→4.4106. The centered J-lens S0 checkpoint was 0.075 < 0.25, so the short-circuit did not fire and the sprint proceeds to S2. Summary SHA-256: `ac592978201053e59ad5d76190826ac9de9b96117eb61faa00d3242b4744b052`; manifest SHA-256: `49f37225c8bc346a865e8baa848bc0745241fc711c13dccba73a5b6d4bcc9614`; both remain under Tempest `analysis/` with `test_or_smoke_read=false` and clean run commit `ba272b0f4934b319667cd0efe7c18036195c60ec`.

**2026-07-14 — S2 seeded null calibration.** On clean run commit `bf5ab70941755565524e5d0963e0d3acd1135014`, 200 seeded neutral prompts produced candidate-restricted means and population standard deviations (`ddof=0`) for J-lens and logit lens across 8 positions x 27 layers: 432 atomic calibration artifacts. Full hash/reuse validation passed; the collection manifest SHA-256 is `d32e8b82510fdbb4b9178fc24a3f1763e84306940b84781e34235573c95ab8e3` and its final checkpoint SHA-256 is `1be6319c34cea7bd8ffd89bb579d861193f1ed6e0f7a40bdf722b488409e97e2`, with `test_or_smoke_read=false`. After integration at S1's selected `clue_last`/layer-21 cell, calibrated J-lens had maximum argmax-label share 0.175 and entropy 3.5495 bits, so G-CONST passed its frozen share <= 0.50 and entropy > 1.50 thresholds.

**2026-07-14 — S1 position x layer sweep.** Slurm job `4226144` completed on one H100 in 00:23:12 at clean run commit `bf5ab70941755565524e5d0963e0d3acd1135014`, using only 1,000 train and 200 dev examples. The 1,200 capture artifacts covered all 8 registered positions x 27 source layers, and the validated 1,512-row analysis selected `clue_last`, layer 21, C=0.01: probe dev top-1 0.835, MRR 0.8824, and log loss 0.8886, so G-INFO passed 0.835 >= 0.25. At that cell calibrated J-lens top-1 was 0.665 (0.7964 x the probe ceiling) versus calibrated logit-lens 0.390, so G-LENS passed both frozen comparisons; G-CONST also passed with maximum label share 0.175 and entropy 3.5495 bits. Sixteen of the 648 exact LBFGS probe fits reached the frozen 1,000-iteration ceiling; the three gate margins are nevertheless non-borderline, and no solver, tolerance, C value, or threshold was changed. Results SHA-256: `660233f6911c4b74ea16ffe21fb309753229ce2863c8a5fcc20f6984cd2a9494`; heatmap SHA-256: `6c0b6da3118b42f63811d9e54169cdccf34bc01ee62dc0d49fe2a5c9c09ba80e`; analysis-manifest SHA-256: `3d42d20ee126b232caa6fb16b0bdd65ec9e3214a04c3b50fa6d0510ea13a3ed2`; `test_or_smoke_read=false`. This is a same-dev-split selected diagnostic maximum, not an unbiased estimate; execution stops here without S3 or S4.
